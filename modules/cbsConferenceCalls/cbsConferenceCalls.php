...
class cbsConferenceCalls extends CRMEntity {
	...
	var $list_fields = Array (
		...
		'conferencecallno'=> Array('cbsconferencecalls', 'conferencecallno'),
		'access_date'=> Array('cbsconferencecalls', 'access_date'),
	...
	var $list_fields_name = Array(
		...
		'conferencecallno'=> 'conferencecallno',
	...
	var $list_link_field = 'conferencecallno';
	...
	var $popup_fields = Array('conferencecallno');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'conferencecallno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'conferencecallno';

	// Required Information for enabling Import feature
	var $required_fields = Array('conferencecallno'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = 'conferencecallno';
	var $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'conferencecallno');
	...
	function vtlib_handler($modulename, $event_type) {
		if($event_type == 'module.postinstall') {
			...
			$module=Vtiger_Module::getInstance('cbsConferenceCalls');
			if ($modAccounts) $modAccounts->setRelatedList($module, 'cbsConferenceCalls', Array('ADD'),'get_dependents_list');
			if ($modContacts) $modContacts->setRelatedList($module, 'cbsConferenceCalls', Array('ADD'),'get_dependents_list');
			if ($modLeads) $modLeads->setRelatedList($module, 'cbsConferenceCalls', Array('ADD'),'get_dependents_list');
			$modCmps=Vtiger_Module::getInstance('Campaigns');
			if ($modCmps) $modCmps->setRelatedList($module, 'cbsConferenceCalls', Array('ADD'),'get_dependents_list');
			// TODO Handle post installation actions
			$this->setModuleSeqNumber('configure', $modulename, 'cbsCalls-', '0000001');
